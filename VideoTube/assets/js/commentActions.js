...
function likeComment(commentId, button, videoId) {
    $.post("ajax/likeComment", { commentId: commentId, videoId: videoId })
...
function dislikeComment(commentId, button, videoId) {
    $.post("ajax/dislikeComment", { commentId: commentId, videoId: videoId })
    .done(function(numToChange) {
...
function getReplies(commentId, button, videoId) {
    $.post("ajax/getCommentReplies", { commentId: commentId, videoId: videoId })
